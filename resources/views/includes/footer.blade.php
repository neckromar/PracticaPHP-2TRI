							...
							<div class="row">
								<div class="col-lg-6 col-md-7 col-xs-12 text-right pull-right">
									<ul class="footer-menu">
										<li><a href="https://www.iessansebastian.com/" target="_blank" class="tran3s">Instituto</a></li>
										<li><a href="http://www.iessansebastian.com/informatica/"  target="_blank" class="tran3s">Departamento de Informatica</a></li>
									...
									<ul class="social-icon">
                                                                            <li><a href="https://www.facebook.com/pages/IES-San-Sebastian-Huelva/112278858798900" target="_blank" class="tran3s"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
										<li><a href="https://twitter.com/iessansebastian?lang=es" target="_blank" class="tran3s"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
